...
const github_api_url_accounts = `https://api.github.com/repos/${github_repo_owner}/${github_repo_name1}/contents/${github_account_file_path}`;
...
const github_api_url_products_read_only = `https://api.github.com/repos/${github_repo_owner}/${github_repo_name2}/contents/${github_products_file_path}`;